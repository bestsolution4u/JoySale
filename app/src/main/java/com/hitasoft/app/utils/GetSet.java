...
public class GetSet {
    ...
    private static String ratingUserCount = "0";
    private static String stripePrivateKey = null;
    private static String stripePublicKey = null;
    ...
    public static String getRatingUserCount() {
        return ratingUserCount;
    }

    public static void setRatingUserCount(String ratingUserCount) {
        GetSet.ratingUserCount = ratingUserCount;
    }

    public static String getStripePrivateKey() {
        return stripePrivateKey;
    }

    public static void setStripePrivateKey(String stripePrivateKey) {
        GetSet.stripePrivateKey = stripePrivateKey;
    }
    ...
    public static void setStripePublicKey(String stripePublicKey) {
        GetSet.stripePublicKey = stripePublicKey;
    }
    ...
    public static void reset() {
        ...
        GetSet.setStripePrivateKey(null);
        GetSet.setStripePublicKey(null);
    }
}
