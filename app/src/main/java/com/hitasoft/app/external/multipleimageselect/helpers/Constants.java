package com.hitasoft.app.external.multipleimageselect.helpers;
...
public class Constants {
    ...
    public static final int SELECTED_IMG_LIMIT = 5;


    public static final String[] CAMERA_PERMISSIONS = new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE, Manifest.permission.WRITE_EXTERNAL_STORAGE};
}
