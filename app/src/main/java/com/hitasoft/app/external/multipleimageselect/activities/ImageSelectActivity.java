package com.hitasoft.app.external.multipleimageselect.activities;
...
import com.hitasoft.app.external.multipleimageselect.adapters.CustomImageSelectAdapter;
import com.hitasoft.app.external.multipleimageselect.helpers.Constants;
...
public class ImageSelectActivity extends HelperActivity {
    ...
    public ArrayList<Photo> selectedImgLists = new ArrayList<>();
    private ArrayList<Integer> selectedPosLists = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        selectedImgLists = new ArrayList<>();
    ...
    private void sendIntent() {
        ...
        selectedImgLists = getSelected();
        intent.putExtra("fromGallery", "enable");
        intent.putExtra("galleryData", selectedImgLists);
    ...
    private ArrayList<Photo> getSelected() {
        ArrayList<Photo> selectedImgs = new ArrayList<>();
        for (int i = 0, l = images.size(); i < l; i++) {
            if (images.get(i).isSelected) {
                Photo tmpMap = new Photo();
                tmpMap.setType("path");
                tmpMap.setImage(images.get(i).path);
                Log.i(TAG, "getSelected: " + tmpMap.getImage());
                selectedImgs.add(tmpMap);
            }
        }
        return selectedImgs;
    }
    ...
    private class ImageLoaderRunnable implements Runnable {
        ...
        public void run() {
            ...
            /*if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
                ...
                cursor = getContentResolver().query(MediaStore.Images.Media.EXTERNAL_CONTENT_URI, projection,
                        MediaStore.Images.Media.DISPLAY_NAME + " =?", new String[]{album}, MediaStore.Images.Media.DATE_ADDED);
            }*/
            cursor = getContentResolver().query(MediaStore.Images.Media.EXTERNAL_CONTENT_URI, projection,
                    MediaStore.Images.Media.BUCKET_DISPLAY_NAME + " =?", new String[]{album}, MediaStore.Images.Media.DATE_ADDED);
            if (cursor == null) {
