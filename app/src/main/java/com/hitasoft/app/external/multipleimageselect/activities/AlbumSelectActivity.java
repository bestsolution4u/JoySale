...
import com.hitasoft.app.external.multipleimageselect.adapters.CustomAlbumSelectAdapter;
...
public class AlbumSelectActivity extends HelperActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == Constants.REQUEST_CODE
            ...
            data.putExtra("fromGallery", data.getStringExtra("fromGallery"));
            ...
            if (cursor.moveToLast()) {
                do {
                    ...
                    if (!albumSet.contains(albumId)) {
                        ...
                        file = new File(image);
                        if (file.exists()) {
                            temp.add(new Album(album, image,picturePath));
