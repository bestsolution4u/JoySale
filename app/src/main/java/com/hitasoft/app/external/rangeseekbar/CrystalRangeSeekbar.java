package com.hitasoft.app.external.rangeseekbar;
...
public class CrystalRangeSeekbar extends View {
    ...
    protected int getBarColorMode(final TypedArray typedArray) {
        return typedArray.getInt(R.styleable.CrystalRangeSeekbar_bar_color_mode, ColorMode.SOLID);
    }
    ...
    protected int getBarHighlightColorMode(final TypedArray typedArray) {
        return typedArray.getInt(R.styleable.CrystalRangeSeekbar_bar_highlight_color_mode, ColorMode.SOLID);
    }
