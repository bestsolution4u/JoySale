...
public class FloatingActionButton extends androidx.appcompat.widget.AppCompatTextView {
    ...
    private void initTypedArray(AttributeSet attrs) {
        ...
        fabTextColor = ta.getColor(R.styleable.FloatingActionButton_fabTextColor, ContextCompat.getColor(getContext(), R.color.white));
    ...
    private void setFont() {
        Typeface face= Typeface.createFromAsset(getContext().getAssets(), "font_regular.ttf");
        setTypeface(face);
    }
    ...
    private void initFabPadding() {
        ...
        setPaddingRelative(horizontalPadding * 2, verticalPadding, horizontalPadding * 2, verticalPadding);
    }
