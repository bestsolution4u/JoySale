...
/**
 * Created by hitasoft on 2/3/18.
 */
public class RangeSeekBar<T extends Number> extends AppCompatImageView {
    private final Paint paint = new Paint(Paint.ANTI_ALIAS_FLAG);
    private final Bitmap thumbImage = getBitmap(R.drawable.custom_thumb_normal);
    private final Bitmap thumbPressedImage = getBitmap(R.drawable.custom_thumb_selected);
    ...
    /**
     * To convert the XML drawable file into Bitmap
     * */
     ...
     */
    public static int DEFAULT_COLOR = Color.parseColor("#c3c9c9");
    ...
    protected synchronized void onDraw(Canvas canvas) {
        ...
        final RectF rect = new RectF(0, 0.5f * (getHeight() - lineHeight), getWidth() - 0, 0.5f * (getHeight() + lineHeight));
        paint.setStyle(Paint.Style.FILL);
        paint.setColor(Color.parseColor("#c3c9c9"));
